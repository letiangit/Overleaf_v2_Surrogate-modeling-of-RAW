...
The prediction of the built surrogate model is compared against the simulation results of a number of randomly chosen data points. It shows, when focus on the data points that are predicated to have high performance by the surrogate model, the relative error between model predication and simulation results is less than 10\% for 95\% the data points.
