...
Different from the homogeneous scenario, heterogeneous networks have more parameters leading to an enormous design space (\textcolor{red}{number of data points}), therefore the number of labeled data points samples required for training is significantly increased. In this paper, we present a novel training methodology that is able to create the surrogate model with high reduced labeled data points samples (i.e., xx\% of the whole design space), and remains high accuracy.
