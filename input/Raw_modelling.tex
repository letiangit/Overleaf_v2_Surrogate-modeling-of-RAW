...
\begin{figure*}[t]
    ...
    \subfloat[data points with \gls{pdr} more than 80\% \label{fig:tx-diff-Prate-08}]{\includegraphics[width=0.45\textwidth]{figures/new_load_avg_result_Prate_tx_all_08_L60}}
